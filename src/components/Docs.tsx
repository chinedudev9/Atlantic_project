...
function docs() {
  return (
    ...
    className="h-auto md:flex px-3 md:px-30 md:gap-10 relative z-20 md:h-[60vh] items-center md:space-y-0 space-y-10 justify-center py-10">
        <div className='w-1/2 mx-auto'>
            <h1 className="text-3xl text-green-900 font-extrabold text-left mb-4">Documents & Download</h1>
        ...
        <div className="w-1/2 mx-auto">
            <h2 className="text-3xl text-green-900 font-extrabold text-left mb-4">Corperate Social Responsibility </h2>
            ...
            <Link href="/documents" className='text-left bg-green-900 py-2 rounded-md px-2 text-white'>Explore Docs</Link>
        </div>
    </div>
  )
}
