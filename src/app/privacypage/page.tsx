...
export default function PrivacyPolicyPage() {
  return (
    <div className=" text-gray-700">
      ...
      <h1 className="md:text-3xl text-xl text-green-800 font-bold mb-6">Privacy & Cookie Policy</h1>
      ...
      <section className="mb-8">
        <h2 className="md:text-xl text-blue-900 font-semibold mb-2">1. Information We Collect</h2>
      ...
      <section className="mb-8">
        <h2 className="md:text-xl font-semibold mb-2 text-blue-900">2. How We Use Your Information</h2>
        <ul className="list-disc pl-5 space-y-1">
      ...
      <section className="mb-8">
        <h2 className="md:text-xl font-semibold mb-2 text-blue-900">3. Cookie Usage</h2>
      ...
      <section className="mb-8">
        <h2 className="md:text-xl font-semibold mb-2 text-blue-900">4. Data Protection</h2>
      ...
      <section className="mb-8">
        <h2 className="md:text-xl font-semibold mb-2 text-blue-900">5. Third-Party Services</h2>
      ...
      <section className="mb-8">
        <h2 className="md:text-xl font-semibold mb-2 text-blue-900">6. Your Rights</h2>
      ...
      <section className="mb-8">
        <h2 className="md:text-xl font-semibold mb-2 text-blue-900">7. Contact</h2>
